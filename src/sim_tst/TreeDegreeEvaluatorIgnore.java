...
public class TreeDegreeEvaluatorIgnore {
	
	public static void main(String[] args) {
		GraphDatabaseService db = new EmbeddedGraphDatabase("var/fstree-didic2_700kNodes_1300Relas");
		TreeDegreeEvaluatorIgnore ev = new TreeDegreeEvaluatorIgnore(db);
	...
	public TreeDegreeEvaluatorIgnore(GraphDatabaseService db) {
		this.db = db;
	}
	...
	private boolean isEventRelated(Node n){
		if(n.getId() == 0) return false;
		for(Relationship rs : n.getRelationships(Direction.INCOMING)){
