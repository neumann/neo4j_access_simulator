...
import simulator.tree.LogIgnoreOperationFactoryTree;

public class WriteIgnoreOps_onTree {
	...
	public static void runWriteOps() {
		...
		for (int i = 0; i < changes.length; i++) {
			...
			LogIgnoreOperationFactoryTree fac = new LogIgnoreOperationFactoryTree("var/ReadWrite_didic4_mix" + i);
			sim = new SimulatorBasic(db, "var/fstree-didic4_700kNodes_1300Relas_randAdd/ReadWrite_didic4_mix" + i, fac);
			Rnd.setSeed(seed);
			sim.startSIM();
			db.shutdown();
